...
:class:`~ogkmc.sites.bond.BondReactionSite`'s.
...
sitting on the surface graph (see :mod:`ogkmc.sites.bond` for
...
Energetics
----------
Identical scheme to :mod:`ogkmc.reactions.diffusion`.  The first time a
...
:class:`ogkmc.io.persistence.ReactionWriter`; the floor is only applied
...
from ogkmc.reactions.rates import EA_MIN, DEFAULT_TRANSMISSION_COEFFICIENT, _eyring_prefactor
...
def _bond_energetics_cached(
    ...
    *,
    ...
    Mirrors :func:`ogkmc.reactions.diffusion._diffusion_energetics_cached`:
...
def get_applicable_bond_reactions(
    ...
    *,
    ...
    Mirrors :func:`ogkmc.reactions.diffusion.get_applicable_diffusions` —
...
def fast_bond_reaction_for_member(
    ...
    *,
    ...
    :func:`ogkmc.reactions.diffusion.fast_diffusion_for_member`.
    """

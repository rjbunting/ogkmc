...
on-the-fly stability / lateral-class workflow of :mod:`ogkmc`:
...
3. If that lateral class has not been ML-relaxed yet, the energies of the
   ...
   :func:`ogkmc.sites.stability.adsorption.check_site_stability` and cached on
...
from ogkmc.reactions.rates import (
...
#: :mod:`ogkmc.kmc.engine`) refer to ``Reaction``; new code should
...
def is_clique_blocked(
    ...
    :func:`~ogkmc.sites.adsorbate.find_adsorbate_sites` and maintained
    by :func:`~ogkmc.kmc.engine._set_member_occupied`.
    """
...
def get_applicable_reactions(
    ...
    *,
    ...
    partial_pressures : dict[str, float] | None
        ...
        1 bar when missing).
    free_energy_options
        Forwarded to :func:`ogkmc.sites.stability.adsorption.check_site_stability`

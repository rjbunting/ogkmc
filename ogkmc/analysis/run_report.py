"""Human-readable, offline reports for persisted OGKMC runs."""
...
from ogkmc.io._files import atomic_output_path, ensure_directory
...
def generate_run_report(
    ...
    *,
    ...
    events_path = _artifact_path(
        ...
        artifact_types=("events", "event_log", "ogkmc.events"),
    )
    reaction_index_path = _artifact_path(
        ...
        artifact_types=("reaction_index", "ogkmc.reaction_index"),
    )

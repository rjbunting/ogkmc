...
from ogkmc.core.pbc import has_real_cell
...
class FreeEnergyOptions:
    ...
    Mirrors :class:`ogkmc.io.config.FreeEnergyCfg` but lives here so the
...
def _cache_context(
    ...
    return tempfile.TemporaryDirectory(prefix="ogkmc_vib_")
...
def compute_gas_thermo(
    ...
    *,
    ...
    engine (see :func:`ogkmc.reactions.adsorption._energetics_cached`), keeping

...
* :func:`find_surface_atoms`
    ...
    :class:`~ogkmc.core.results.SurfaceClassification` (which is also iterable
...
from ogkmc.core.results import SurfaceClassification
from ogkmc.core.constants import (
    NL_MULT_DEFAULT,
    RAYCAST_COVERAGE_THRESHOLD,
    RAYCAST_N_DISC_SAMPLE,
)
from ogkmc.core.pbc import minimum_image_vectors, set_full_pbc_if_cell
...
def _pbc_connectivity_axes(
    ...
    nl_mult : float
        ...
        to :data:`ogkmc.core.constants.NL_MULT_DEFAULT`.
...
def align_periodic_slab_frame(
    ...
    *,
    ...
    atoms.info["_ogkmc_surface_frame"] = metadata
    return metadata
...
def find_surface_atoms_raycasting(
    ...
    *,
    ...
    atoms.info["_ogkmc_surface_side"] = which

...
from ogkmc.io.event_log import (  # noqa: F401
    EventLogCommit,
    EventLogRecovery,
    reconcile_event_log,
)
...
from ogkmc.io.reaction_layout import (
...
from ogkmc.io.reaction_payloads import build_reaction_payload
from ogkmc.io.records import ReactionRecord
from ogkmc.io.schemas import (
    EVENT_SCHEMA_VERSION,
    REACTION_DOCUMENT_ARTIFACT_TYPE,
    REACTION_DOCUMENT_SCHEMA_VERSION,
)
from ogkmc.species.smiles import smiles_to_dirname as _smiles_to_dirname
...
def write_invalid_adsorption_diagnostic(
    ...
    *,
    ...
    _atomic_json(
        ...
        {
            "artifact_type": "ogkmc-invalid-adsorption-diagnostic",
            "schema_version": "1",
            "kind": "adsorption",
            "iso_class": iso_class,
...
def _event_free_energetics(
    ...
    from ogkmc.reactions.rates import EA_MIN as _EA_MIN
...
class ReactionWriter:
    ...
    * ``reaction.json``     — description + energies + ΔE / barrier / rate
    ...
    def write_invalid_adsorption(self, site, lc, *, step: int = 0) -> Path:
        ...
        payload = {
            "artifact_type": "ogkmc-invalid-adsorption-lateral-diagnostic",
            "schema_version": "1",
            "kind": "adsorption",
            "discovery_step": int(step),
            "iso_class": iso,
    ...
    def write_bare_neb(self, site, lc, *, kind: str, step: int = 0) -> Path | None:
        ...
        _atomic_json(metadata_path, {
            "artifact_type": "ogkmc-bare-neb-diagnostic",
            "schema_version": "1",
            "run_id": self.run_id,
            "kind": kind,
            "iso_class": int(site.iso_class),

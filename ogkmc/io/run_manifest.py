...
from ogkmc.io._files import write_json_atomic
from ogkmc.io.event_transitions import occupied_surface_states
from ogkmc.io.performance import (
    PERFORMANCE_DIAGNOSTICS_RELATIVE_PATH,
    PERFORMANCE_DIAGNOSTICS_SCHEMA_VERSION,
)
from ogkmc.io.reaction_index import REACTION_INDEX_FILENAME
...
def configured_artifact_descriptors(
    ...
    *,
    ...
    from ogkmc.io.checkpoint import CHECKPOINT_SCHEMA_VERSION

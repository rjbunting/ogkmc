...
from ogkmc.sites.stability.intermediate_pruning import CompositeDirectEventDetected
...
def resolve_neb_image_count(
    ...
    *,
    ...
    ``n_images`` in ASE/OGKMC means *interior* images, so a band has
...
def run_neb(
    ...
    *,
    ...
    If five rollback halvings collapse its timestep, OGKMC disables the

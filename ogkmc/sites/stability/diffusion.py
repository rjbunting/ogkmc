"""
ogkmc.sites.stability.diffusion
=============================
On-the-fly lateral-interaction classifier and CI-NEB stability / barrier
calculator for materialised diffusion (hop) sites.

This is the diffusion analogue of :mod:`ogkmc.sites.stability.adsorption`.  Each
:class:`~ogkmc.sites.diffusion.DiffusionSite` enumerates an
...
def _diffusion_lateral_node_match(d1: dict, d2: dict) -> bool:
    ...
    Same as :func:`ogkmc.sites.stability.adsorption._lateral_node_match` but
...
def _build_diffusion_lateral_ego_graph(
    ...
    *,
    ...
    Mirrors :func:`ogkmc.sites.stability.adsorption._build_lateral_ego_graph`
...
def _build_diffusion_atoms(
    ...
    * ``"b"`` → coordinates from B's nodes (matched 1-to-1 by
    ...
    :func:`ogkmc.sites.stability.adsorption._expand_to_full_placement`, with
...
def _relax_endpoint(
    ...
    *,
    ...
    """
    from ogkmc.structure import (  # local: avoid cycle
...
def check_diffusion_stability(
    ...
    *,
    ...
    1. Build endpoint-A Atoms (slab + lateral neighbours + migrating
       ...
       :func:`~ogkmc.structure.optimise_structure`; run the standard
    ...
    frozen_indices : list[int] | None
        ...
        Same convention as :func:`ogkmc.sites.stability.adsorption.check_site_stability`.

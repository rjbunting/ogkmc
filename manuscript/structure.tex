...
\usepackage[default]{opensans} % Use Open Sans as the cover-letter font
...
\address{
	\includegraphics[width=6cm]{\logo} % Include the logo of author institution
	\hspace{\textwidth} % Position of the institution logo, increase to move left, decrease to move right
...
\renewcommand{\opening}[1]{
	{\hfill\fromaddress\vspace{0.01\textheight} \\ % Print the header and from address here, add whitespace to move date down

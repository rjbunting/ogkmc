...
def _kabsch_align_ego(
    ...
    tried (defaults to :data:`autokmc2.core.constants.KABSCH_MAX_MAPPINGS`) so that
...
def _optimise_position(
    ...
    *,
    ...
    :mod:`autokmc2.structure` where the surface normal is aligned with +z).
    ...
    if use_mic:
        ...
        # :func:`autokmc2.structure._orthogonalise_slab` guarantees the
...
def _enumerate_cliques(
    ...
    * **Slabs** — a clique whose centroid sits below the lowest surface
      ...
      orthogonalised slabs that :mod:`autokmc2.structure` produces.
    """

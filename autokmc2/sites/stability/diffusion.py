"""
autokmc2.sites.stability.diffusion
=============================
On-the-fly lateral-interaction classifier and CI-NEB stability / barrier
calculator for materialised diffusion (hop) sites.

This is the diffusion analogue of :mod:`autokmc2.sites.stability.adsorption`.  Each
:class:`~autokmc2.sites.diffusion.DiffusionSite` enumerates an
...
defaults live in :mod:`autokmc2.core.constants` (``NEB_*``).
...
from autokmc2.sites.diffusion import (
    DiffusionSite,
    DiffusionLateral,
...
def _diffusion_lateral_node_match(d1: dict, d2: dict) -> bool:
    ...
    Same as :func:`autokmc2.sites.stability.adsorption._lateral_node_match` but
...
def _build_diffusion_lateral_ego_graph(
    ...
    *,
    ...
    Mirrors :func:`autokmc2.sites.stability.adsorption._build_lateral_ego_graph`
...
def _build_diffusion_atoms(
    ...
    * ``"b"`` → coordinates from B's nodes (matched 1-to-1 by
    ...
    :func:`autokmc2.sites.stability.adsorption._expand_to_full_placement`, with
...
def _relax_endpoint(
    ...
    *,
    ...
    """
    from autokmc2.structure import optimise_structure  # local: avoid cycle
...
def check_diffusion_stability(
    ...
    *,
    ...
    1. Build endpoint-A Atoms (slab + lateral neighbours + migrating
       ...
       :func:`~autokmc2.structure.optimise_structure`; run the standard
    ...
    frozen_indices : list[int] | None
        ...
        Same convention as :func:`autokmc2.sites.stability.adsorption.check_site_stability`.

...
between materialised :class:`~autokmc2.sites.adsorbate.AdsorbateSite`'s.
...
:mod:`autokmc2.sites.adsorbate` / :mod:`autokmc2.sites.stability.adsorption`
and :mod:`autokmc2.sites.diffusion` / :mod:`autokmc2.sites.stability.diffusion`:
...
* :mod:`autokmc2.sites.stability.bond` — on-the-fly lateral-environment
...
Templates are derived from :mod:`autokmc2.species.bond_chemistry`:
...
from autokmc2.sites.diffusion import _member_clique_union
...
class BondReactionTemplate:
    ...
    bond_type : str
        ...
        :func:`autokmc2.species.bond_chemistry.combine_fragments`.
...
class BondReactionLateral:
    ...
    Mirrors :class:`autokmc2.sites.diffusion.DiffusionLateral` but for a
    three-state reversible reaction.  Energies / atoms / TS are filled in
    lazily during the KMC loop by :mod:`autokmc2.sites.stability.bond`.
    ...
    ego_graph : nx.Graph | None
        ...
        on-the-fly lateral classifier in :mod:`autokmc2.sites.stability.bond`).
    n_shells : int
    ...
    atoms_ab, atoms_c, atoms_ts : Atoms | None
        ...
        :class:`autokmc2.io.persistence.ReactionWriter`.
    ...
    # ── Free-energy / vibrational fields (autokmc2.thermo.free_energy) ────────────
...
class BondReactionSite:
    ...
    lateral_classes : list[BondReactionLateral]
        Lazily populated by
        :func:`autokmc2.sites.stability.bond.check_bond_site_lateral`.
    """
    template        : BondReactionTemplate
    iso_class       : int
    ...
    # populated by :func:`find_bond_sites`.  Used by :mod:`autokmc2.reactions.bond`
...
def derive_dissociation_templates(
    ...
    *,
    ...
    :func:`autokmc2.species.bond_chemistry.get_all_fragments` (with
    ...
    smiles, bond_types, include_ring_bonds, add_hydrogens
        Forwarded to :func:`autokmc2.species.bond_chemistry.get_all_fragments`
        (the latter receives ``strip_dummies=True``).
    """
    from autokmc2.species.bond_chemistry import get_all_fragments
...
def derive_coupling_templates(
    ...
    *,
    ...
    :class:`~autokmc2.species.bond_chemistry.CombinedSpecies` returned by
    :func:`autokmc2.species.bond_chemistry.combine_fragments`.
    ...
    include_hetero : bool
        ...
        Default ``True``.
    """
    from autokmc2.species.bond_chemistry import combine_fragments
...
def _build_triple_ego_graph(
    ...
    *,
    ...
    Generalisation of
    :func:`autokmc2.sites.diffusion._build_pair_ego_graph` to three
...
def _prune_one_per_adsorption_triple(
    ...
    *,
    ...
    Mirrors :func:`autokmc2.sites.diffusion._prune_one_per_adsorption_pair`.
    """
...
def find_bond_sites(
    ...
    *,
    ...
    adsorbate_sites : iterable of AdsorbateSite
        ...
        :func:`~autokmc2.sites.adsorbate.find_adsorbate_sites` output
    ...
    max_hops : int
        ...
        :data:`autokmc2.core.constants.BOND_MAX_HOPS`).
    surface_apsp_cutoff : int
        Cutoff handed to
        :func:`autokmc2.sites.adsorbate._get_surface_apsp` for the
...
def prune_unstable_bond_sites(
    ...
    **after** this function — viability comes first.
    ...
    species_by_smiles : Mapping[str, Reactant]
        Map from canonical SMILES → :class:`~autokmc2.species.reactant.Reactant`.
        Used to look up chemical symbols and intramolecular bond
        topology.  Pass ``G.graph["bond_registry"]["species"]`` after
        :func:`autokmc2.kmc.expansion.initialise_bond_registry` has run.
    calculator
    ...
    frozen_indices, fmax, max_steps, nl_mult, verbose
        See :func:`autokmc2.sites.adsorbate.prune_unstable_adsorbate_sites`.
    ...
    from autokmc2.structure import optimise_structure

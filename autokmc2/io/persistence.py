...
from autokmc2.io.records import ReactionRecord
from autokmc2.species.smiles import smiles_to_dirname as _smiles_to_dirname
    ...
    def _write_reaction_json(
        ...
        *,
        ...
        if sub == "diffusion":
            ...
            from autokmc2.reactions.rates import EA_MIN as _EA_MIN

"""
autokmc2.reactions.bond
================
Build KMC **bond-changing** reactions for a graph of materialised
:class:`~autokmc2.sites.bond.BondReactionSite`'s.
...
sitting on the surface graph (see :mod:`autokmc2.sites.bond` for
...
Energetics
----------
Identical scheme to :mod:`autokmc2.reactions.diffusion`.  The first time a
...
:class:`autokmc2.io.persistence.ReactionWriter`; the floor is only applied
...
from autokmc2.reactions.rates import EA_MIN, DEFAULT_TRANSMISSION_COEFFICIENT, _eyring_prefactor
...
def _bond_energetics_cached(
    ...
    *,
    ...
    Mirrors :func:`autokmc2.reactions.diffusion._diffusion_energetics_cached`:
...
def get_applicable_bond_reactions(
    ...
    *,
    ...
    Mirrors :func:`autokmc2.reactions.diffusion.get_applicable_diffusions` —
...
def fast_bond_reaction_for_member(
    ...
    *,
    ...
    :func:`autokmc2.reactions.diffusion.fast_diffusion_for_member`.
    """

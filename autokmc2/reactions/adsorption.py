...
on-the-fly stability / lateral-class workflow of :mod:`autokmc2`:
...
3. If that lateral class has not been ML-relaxed yet, the energies of the
   ...
   :func:`autokmc2.sites.stability.adsorption.check_site_stability` and cached on
...
from autokmc2.reactions.rates import (
...
#: :mod:`autokmc2.kmc.engine`) refer to ``Reaction``; new code should
...
def is_clique_blocked(
    ...
    :func:`~autokmc2.sites.adsorbate.find_adsorbate_sites` and maintained
    by :func:`~autokmc2.kmc.engine._set_member_occupied`.
    """
...
def get_applicable_reactions(
    ...
    *,
    ...
    partial_pressures : dict[str, float] | None
        ...
        1 bar when missing).
    free_energy_options
        Forwarded to :func:`autokmc2.sites.stability.adsorption.check_site_stability`

...
class FreeEnergyOptions:
    ...
    Mirrors :class:`autokmc2.io.config.FreeEnergyCfg` but lives here so the
...
def compute_gas_thermo(
    ...
    *,
    ...
    engine (see :func:`autokmc2.reactions.adsorption._energetics_cached`), keeping

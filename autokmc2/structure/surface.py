...
* :func:`find_surface_atoms`
    ...
    :class:`~autokmc2.core.results.SurfaceClassification` (which is also iterable
...
from autokmc2.core.results import SurfaceClassification
...
def has_pbc_connectivity(atoms: Atoms,
    ...
    nl_mult : float
        ...
        to :data:`autokmc2.core.constants.NL_MULT_DEFAULT`.

...
from autokmc2.core.constants import RANDOM_SEED
...
from autokmc2.structure.optimization import _resolve_lattice_params, optimise_structure
...
def _get_bottom_layer_indices(atoms: Atoms, n_layers: int) -> list:
    ...
    from autokmc2.structure.surface import find_surface_atoms_raycasting

...
4. Build a :class:`networkx.Graph` via :func:`~autokmc2.core.graph.build_graph`.
5. Compute intramolecular automorphism orbits (per element) — the
   ...
   in :mod:`autokmc2.sites.adsorbate`.
...
from autokmc2.species.smiles import smiles_to_dirname
...
class Reactant:
    ...
    graph : nx.Graph
        Connectivity graph built by :func:`~autokmc2.core.graph.build_graph`.
    ...
    energy : float
        ...
        ``E_gas`` in :func:`autokmc2.sites.adsorbate.optimise_unique_configurations`.
    ...
    # ── Free-energy / vibrational fields (populated by autokmc2.thermo.free_energy) ──
    ...
    #: adsorption rate in :func:`autokmc2.reactions.adsorption._energetics_cached`
...
def find_anchor_atoms(
    ...
    *,
    ...
    :func:`autokmc2.sites.adsorbate.enumerate_configurations`.  An atom is
...
def build_reactant(
    ...
    *,
    ...
    if (
        ...
        try:
            from autokmc2.thermo.free_energy import compute_gas_thermo

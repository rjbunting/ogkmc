...
DEBUG_ENDPOINT_DIR = Path("ch4_activation_debug") / "pruning_endpoints"
...
print(
    "Writing A+B endpoint structures before/after pruning optimisation to "
    f"{DEBUG_ENDPOINT_DIR}/"
)
bond_sites = prune_unstable_bond_sites(
    ...
    max_steps      = 200,
    verbose        = True,
    debug_output_dir = DEBUG_ENDPOINT_DIR,
)

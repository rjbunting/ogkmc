"""
autokmc.species.bond_chemistry
===============================
...
* If *smiles_or_atoms* is an ASE :class:`~ase.Atoms` object, connectivity is
  ...
  :func:`autokmc.core.graph.build_graph`; bond orders default to ``SINGLE``.
"""
...
class FragmentPair:
    ...
    reactant_a : Reactant or None
        :class:`autokmc.species.reactant.Reactant` for fragment A; populated only
        when :func:`get_all_fragments` is called with ``as_reactants=True``.
    reactant_b : Reactant or None
        :class:`autokmc.species.reactant.Reactant` for fragment B.
    """
...
class CombinedSpecies:
    ...
    reactant : Reactant or None
        :class:`autokmc.species.reactant.Reactant` for the combined species;
...
def combine_fragments(
    ...
    **Round-trip: break CO double bond, recombine**::
        ...
        >>> from autokmc.species.bond_chemistry import get_all_fragments, combine_fragments

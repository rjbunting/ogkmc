"""
autokmc.check_bond_sites
========================
On-the-fly lateral-interaction classifier and CI-NEB stability / barrier
calculator for materialised :class:`~autokmc.find_bond_sites.BondReactionSite`'s.

This is the bond-reaction analogue of :mod:`autokmc.check_diffusion_sites`.
Each :class:`~autokmc.find_bond_sites.BondReactionSite` enumerates an
...
2. The **two endpoint relaxations** for that lateral class — one ML
   ...
   :class:`~autokmc.find_bond_sites.BondReactionLateral`.
...
Lateral ego-graph conventions (extends :mod:`autokmc.check_adsorbate_sites`)
---------------------------------------------------------------------------
...
from .check_adsorbate_sites import (
...
# ---------------------------------------------------------------------------
# Errors  (mirror autokmc.check_diffusion_sites)
# ---------------------------------------------------------------------------

class BondStabilityError(Exception):
    """Base class for all bond-reaction stability / NEB failures.

    Caught by :func:`autokmc.kmc_bond.get_applicable_bond_reactions` and
...
def _bond_lateral_node_match(d1: dict, d2: dict) -> bool:
    ...
    Like :func:`autokmc.check_diffusion_sites._diffusion_lateral_node_match`
...
def _build_bond_lateral_ego_graph(
    ...
    *,
    ...
    Mirrors :func:`autokmc.check_diffusion_sites._build_diffusion_lateral_ego_graph`
...
def _check_bond_ts_validity(
    ...
    *,
    ...
    Mirrors :func:`autokmc.check_diffusion_sites._check_ts_validity` with
...
def check_bond_site_stability(
    ...
    *,
    ...
    Pipeline (mirrors :func:`autokmc.check_diffusion_sites.check_diffusion_stability`):

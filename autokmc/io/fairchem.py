...
The imports stay inside the public helper so AutoKMC does not require Torch or
...
def get_predict_unit_on_device(
    ...
    **kwargs: Any,
    ...
    ordinal from PyTorch's current device.  AutoKMC configurations can pass
    ...
    if n_workers != 1:
        raise ValueError(
            "get_predict_unit_on_device requires workers=1; use AutoKMC "

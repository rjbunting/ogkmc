"""
autokmc.check_diffusion_sites
=============================
On-the-fly lateral-interaction classifier and CI-NEB stability / barrier
calculator for materialised diffusion (hop) sites.

This is the diffusion analogue of :mod:`autokmc.check_adsorbate_sites`.  Each
:class:`~autokmc.find_diffusion_sites.DiffusionSite` enumerates an
...
defaults live in :mod:`autokmc.constants` (``NEB_*``).
...
def _build_diffusion_lateral_ego_graph(
    ...
    *,
    ...
    Mirrors :func:`autokmc.check_adsorbate_sites._build_lateral_ego_graph`
...
def _build_diffusion_atoms(
    ...
    * ``"b"`` → coordinates from B's nodes (matched 1-to-1 by
    ...
    :func:`autokmc.check_adsorbate_sites._expand_to_full_placement`, with
...
def check_diffusion_stability(
    ...
    *,
    ...
    frozen_indices : list[int] | None
        ...
        Same convention as :func:`autokmc.check_adsorbate_sites.check_site_stability`.
